...
- **内置题库**：40 关共 200 题（桌面文档《小学AI+百科知识题库》导入），覆盖 AI 常识（提示词、AI 应用、隐私安全、AI 伦理）与百科知识（天文地理、生物科学、历史文化、生活常识），其中单选 120 道 + 判断 80 道（以「正确/错误」形式呈现）
...
**重新生成题库数据**（桌面 xlsx 题库变更后）：

```bash
python tools_gen_static_data.py   # 读取桌面《小学AI+百科知识题库.xlsx》重新生成 data.js
```
